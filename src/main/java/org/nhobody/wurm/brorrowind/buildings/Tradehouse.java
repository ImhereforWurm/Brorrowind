...
public class Tradehouse {
    public static void onItemTemplatesCreated() {
        ...
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Tradehouse");
        builder.name("Tradehouse", "Tradehouse", "Arrille's Tradehouse.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Tradehouse.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Tradehouse.", e);
        }
    }
}
