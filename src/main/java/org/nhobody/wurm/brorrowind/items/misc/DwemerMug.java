...
public class DwemerMug {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DwemerMug");
        builder.name("Dwemer Mug", "Dwemer Mug", "An ancient mug.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for DwemerMug.", e);
        }
    }
}
