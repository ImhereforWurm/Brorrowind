...
public class DaedricDaikatana {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DaedricDaikatana");
        builder.name("Daedric Dai-Katana", "Daedric Dai-Katanas", "Metal infused with the power of the daedra.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.DaedricDaikatana.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Daedric Dai-Katana.", e);
        }
        if(template != null) {
            ...
            new Weapon(template.getTemplateId(), Brorrowind.daedricDaikatanaDamage, Brorrowind.daedricDaikatanaSpeed, Brorrowind.daedricDaikatanaCrit, 4, 5, Brorrowind.daedricDaikatanaParry, 0.0D);
