...
public class DaedricKatana {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DaedricKatana");
        builder.name("Daedric Katana", "Daedric Katanas", "Metal infused with the power of the daedra.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.DaedricKatana.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Daedric Katana.", e);
        }
        if(template != null) {
            ...
            new Weapon(template.getTemplateId(), Brorrowind.daedricKatanaDamage, Brorrowind.daedricKatanaSpeed, Brorrowind.daedricKatanaCrit, 3, 3, Brorrowind.daedricKatanaParry, 0.0D);
