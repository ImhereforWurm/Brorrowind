...
public class DaedricScythe {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DaedricScythe");
        builder.name("Daedric Scythe", "Daedric Scythes", "Metal infused with the power of the daedra.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.DaedricScythe.");
        ...
        builder.primarySkill(SkillList.SCYTHE);
        ...
        if(template != null) {
            //weapon stats: scythe
            //new Weapon(template.getTemplateId(), 9.0F, 5.0F, 0.08F, 5, 4, 0.2F, 2.0D);
            //new Weapon(template.getTemplateId(), 11.4F, 4.5F, 0.08F, 5, 4, 0.2F, 2.0D);
            new Weapon(template.getTemplateId(), Brorrowind.daedricScytheDamage, Brorrowind.daedricScytheSpeed, Brorrowind.daedricScytheCrit, 5, 4, Brorrowind.daedricScytheParry, Brorrowind.daedricScytheSkillpenalty);
            ...
            if (Brorrowind.enableDaedricWeaponsCrafting) {
                AdvancedCreationEntry craftEntry = CreationEntryCreator.createAdvancedEntry(SkillList.GROUP_SMITHING_WEAPONSMITHING,
                        ItemList.scytheBlade, ItemList.shaft, template.getTemplateId(), true, false, 0.0f, true, false, 0, 50, CreationCategories.WEAPONS);
