...
public class DaedricWakazashi {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DaedricWakazashi");
        builder.name("Daedric Wakazashi", "Daedric Wakazashis", "Metal infused with the power of the daedra.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.DaedricWakazashi.");
        ...
        builder.primarySkill(SkillList.SWORD_SHORT);
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Daedric Wakazashi.", e);
        }
        if(template != null) {
            //weapon stats: short sword
            //new Weapon(template.getTemplateId(), 4.0F, 3.0F, 0.1F, 2, 1, 1.0F, 0.0D);
            //new Weapon(template.getTemplateId(), 6.5F, 3.0F, 0.1F, 2, 1, 1.0F, 0.0D);

            new Weapon(template.getTemplateId(), Brorrowind.daedricWakazashiDamage, Brorrowind.daedricWakazashiSpeed, Brorrowind.daedricWakazashiCrit, 2, 1, Brorrowind.daedricWakazashiParry, 0.0D);
