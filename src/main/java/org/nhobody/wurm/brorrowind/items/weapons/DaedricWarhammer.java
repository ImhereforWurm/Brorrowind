...
public class DaedricWarhammer {

    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DaedricWarhammer");
        builder.name("Daedric Warhammer", "Daedric Warhammer", "Metal infused with the power of the daedra.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.DaedricWarhammer.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Daedric Warhammer.", e);
        }
        if(template != null) {
            //weapon stats: large maul
            //new Weapon(template.getTemplateId(), 11.0F, 6.0F, 0.03F, 4, 5, 1.0F, 0.0D);
            //new Weapon(template.getTemplateId(), 13.25F, 5.25F, 0.03F, 4, 5, 1.0F, 0.0D);
            new Weapon(template.getTemplateId(), Brorrowind.daedricWarhammerDamage, Brorrowind.daedricWarhammerSpeed, Brorrowind.daedricWarhammerCrit, 4, 5, Brorrowind.daedricWarhammerParry, 0.0D);
