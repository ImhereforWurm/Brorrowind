...
public class DwemerClaymore {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DwemerClaymore");
        builder.name("Dwemer Claymore", "Dwemer Claymore", "A weapon forged by a long forgotten people.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.DwemerClaymore.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for DwemerClaymore.", e);
        }
        if(template != null) {
            ...
            new Weapon(template.getTemplateId(), Brorrowind.dwemerClaymoreDamage, Brorrowind.dwemerClaymoreSpeed, Brorrowind.dwemerClaymoreCrit, 4, 5, Brorrowind.dwemerClaymoreParry, 0.0D);
