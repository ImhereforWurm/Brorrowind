...
public class DwemerWaraxe {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.DwemerWaraxe");
        builder.name("Dwemer Waraxe", "Dwemer Waraxe", "A weapon forged by a long forgotten people.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.DwemerWaraxe.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for DwemerWaraxe.", e);
        }
        if(template != null) {
            ...
            new Weapon(template.getTemplateId(), Brorrowind.dwemerWaraxeDamage, Brorrowind.dwemerWaraxeSpeed, Brorrowind.dwemerWaraxeCrit, 4, 5, Brorrowind.dwemerWaraxeParry, 0.0D);
