...
public class GlassDagger {
    public static void onItemTemplatesCreated() {
        ...
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.GlassDagger");
        builder.name("Glass Shortsword", "Glass Shortsword", "Forged from rare metals and volcanic glass, this weapon is extremely light.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.GlassDagger.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for GlassDagger.", e);
        }
        if(template != null) {
            ...
            new Weapon(template.getTemplateId(), Brorrowind.glassDaggerDamage, Brorrowind.glassDaggerSpeed, Brorrowind.glassDaggerCrit, 2, 1, Brorrowind.glassDaggerParry, 0.0D);
