...
public class GlassHalberd {
    public static void onItemTemplatesCreated() {

        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.GlassHalberd");
        builder.name("Glass Halberd", "Glass Halberd", "Forged from rare metals and volcanic glass, this weapon is extremely light.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.GlassHalberd.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for GlassHalberd.", e);
        }
        if(template != null) {
            ...
            new Weapon(template.getTemplateId(), Brorrowind.glassHalberdDamage, Brorrowind.glassHalberdSpeed, Brorrowind.glassHalberdCrit, 6, 8, Brorrowind.glassHalberdParry, 0.0D);
