...
public class Argonian {
    public static void onItemTemplatesCreated() {
        ...
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Argonian");
        builder.name("Argonian", "Argonians", "Beastmen from the southern swamps.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Argonian.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Argonian.", e);
        }
