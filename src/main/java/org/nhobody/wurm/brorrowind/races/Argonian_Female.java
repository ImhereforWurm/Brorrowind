...
public class Argonian_Female {
    public static void onItemTemplatesCreated() {
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Argonian_Female");
        builder.name("Argonian_Female", "Argonian_Female", "Beastmen from the southern swamps. Lets hope this one isn't lusty.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Argonian_Female.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Argonian_Female.", e);
        }
