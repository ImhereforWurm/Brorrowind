...
public class Bosmer {
    public static void onItemTemplatesCreated() {
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Bosmer");
        builder.name("Bosmer", "Bosmer", "Wood elves, known for their love of trees and cannibalism. This one looks like he's lost his family ring.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Bosmer.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Bosmer.", e);
        }
