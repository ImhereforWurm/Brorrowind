...
public class Dunmer {
    public static void onItemTemplatesCreated() {
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Dunmer");
        builder.name("Dunmer", "Dunmer", "Natives of Brorrowind.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Dunmer.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Dunmer.", e);
        }
