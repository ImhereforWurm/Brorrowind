...
public class Dunmer_Female {
    public static void onItemTemplatesCreated() {
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Dunmer_Female");
        builder.name("Dunmer_Female", "Dunmer_Female", "Natives of Brorrowind.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Dunmer_Female.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Dunmer_Female.", e);
        }
