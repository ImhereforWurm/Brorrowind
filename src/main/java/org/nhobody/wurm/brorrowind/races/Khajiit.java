...
public class Khajiit {
    public static void onItemTemplatesCreated() {
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Khajiit");
        builder.name("Khajiit", "Khajiit", "Beastmen with a proclivity for Moonsugar.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Khajiit.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Khajiit.", e);
        }
