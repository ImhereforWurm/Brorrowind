...
public class Orsimer {
    public static void onItemTemplatesCreated() {
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Orsimer");
        builder.name("Orsimer", "Orsimer", "Mer from Orsinium, often referred to as Orcs.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Orsimer.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Orsimer.", e);
        }
