...
public class Orsimer_Female {
    public static void onItemTemplatesCreated() {
        ItemTemplateBuilder builder = new ItemTemplateBuilder("mod.nhobody.Brorrowind.Orsimer_Female");
        builder.name("Orsimer_Female", "Orsimer_Female", "Mer from Orsinium, often referred to as Orcs.");
        ...
        builder.modelName("model.mod.nhobody.Brorrowind.Orsimer_Female.");
        ...
        try {
            ...
            Brorrowind.logger.log(Level.SEVERE, "Failed while creating item template for Orsimer_Female.", e);
        }
